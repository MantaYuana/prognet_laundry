                ...
                <div class="card bg-base-100 shadow-xl">
                    <div class="card-body">
                        ...
                        <div class="card-actions flex items-center gap-4 justify-end mt-6">
                            <button type="button" 
                                    onclick="window.location='{{ $isCustomer ? route('customer.orders.index') : route('outlet.customer.order.index', ['outlet' => request()->route('outlet'), 'customer' => request()->route('customer')]) }}'" 
                                    class="btn btn-ghost">
                                Cancel
                            </button>
