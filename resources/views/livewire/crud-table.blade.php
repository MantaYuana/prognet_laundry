<div class="">
    ...
    <div class="w-full mt-6 flex flex-row justify-between">
        ...
        <div class="h-16 flex justify-start flex-row items-center">
            ...
            <p class="ml-3">Outlet</p>
        </div>

        <!-- INSERT BUTTON -->
        <div class="flex items-center justify-center">
            <a href="#"
                class="w-[150px] text-center bg-primary py-2 px-3 rounded-md hover:opacity-80 font-bold text-white">
                + Insert
            </a>
        </div>
...
<div
    ...
    <div class="mr-5 flex items-center">
        ...
        @if ($rows->onFirstPage())
            <button
                class="border mr-3 cursor-not-allowed opacity-40 bg-surface rounded-md border-line px-3 py-2">
